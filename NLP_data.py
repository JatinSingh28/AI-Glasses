data = [
    ...
    ["Describe my surroundings.", 1],
    ["Run realtime object detection.", 1],
    ...
    ["Run face recognition", 2],
    ["Try to identify people near me", 2],
    ...
    # ["Hey read it for me", 4],
    # ["Read the newspaper", 4],
    ...
    # ["Generate caption of my view", 5],
    # ["Run image caption generator",5]
